...
export function TerminalHeader() {
  return (
    <header className="shrink-0 border-b border-white/[0.06] !py-2 sm:!py-2.5 bg-[#0D0D0D]/80 backdrop-blur-sm">
      <div className="flex items-center justify-between gap-2 min-w-0">
        ...
        <div className="flex items-center gap-4 sm:gap-6 shrink-0">
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 text-xs font-mono text-[#D2FF70] border border-[#D2FF70]/25 rounded-lg !px-3 sm:!px-4 !py-2.5 min-h-[44px] hover:bg-[#D2FF70]/10 hover:border-[#D2FF70]/40 transition-all duration-200 hover:shadow-[0_0_20px_rgba(210,255,112,0.08)]"
          >
